...
const ICON_PATHS: Record<IconType, ReactNode> = {
  ...
  // מטוס נוסעים קלאסי מבט מלמעלה: גוף רחב, כנפיים רחבות לצדדים, וייצוב זנב אחורי.
  // מכוון "כלפי מעלה" כברירת מחדל, ומסובב ב-45° לכל כיוון כדי לתאר המראה/נחיתה.
  takeoff: (
    <g transform="rotate(45 12 12)">
      <path d="M12 2v19" />
      <path d="M3 15 12 11 21 15" />
      <path d="M9 20 12 18 15 20" />
    </g>
  ),
  landing: (
